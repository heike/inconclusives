...
- Move Figure 8 into the appendix (done)
- Insert a paragraph to explain the need for a sufficient sample size to see a difference between 0.02 and 0.2
...
> HH: The Keisler data is not one of the large studies - insofar there is no direct contradiction beteween the figure and the text, but we agree, that the explanation might not be explicit enough.
> We included, as suggested, three other studies (VCMER, Mattijssen and ) 
