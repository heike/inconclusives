...
\item [Blind testing] A blind (or blinded) study is one in which the participant (in this case the examiner) does not know that they are being tested; that is, a study which appears to be part of a case, rather than research. \citet{pcast2016} recommended that the use of blind testing be increased, as error rates derived from blind studies better generalize to casework. \svp{\citet{spiegelmanAnalysisExperimentsForensic2013} also suggest blind testing as a method to increase the external validity of studies beyond assessing the proficiency of individual examiners.}
