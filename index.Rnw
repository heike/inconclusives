...
218 participants sent evaluations: \hfill\newline
...
Each test kit consisted of 20 pairs of cartridge cases. Each set consisted of 12 same source pairs and 8 pairs from different sources.
