...
\begin{itemize}
\item \hh{The design of the study does not allow for an assessment of all of the error and accuracy rates discussed in \section{sec:rates}, but shows a strong focus on evaluating identifications. }
