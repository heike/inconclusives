...
In actual case work we are not able to assess the probabilities for same source or different source.  However, those probabilities could be determined in blinded proficiency testing. 
