...
\clearpage
\paragraph{Lilien} The Lilien study  \citep{lilienFirearmForensicsBlackBox2019} used virtual microscopy to evaluate scans of cartridge cases. Each participant was asked to make sixteen evaluations of breech face impressions. These consisted of forty sets of two known and one unknown bullets: 
