...
For instance, \citet{Dror:2018fp} suggests treating inconclusive results as an examiner's conscious decision to not decide on an identification or elimination. \hh{XXX what is the consequence of that? }
