...
\multicolumn{1}{r|}{} & Identification & Inconclusive & \multicolumn{1}{r|}{Elimination} \\\hline
Same source & $a/(a+d)$ & $b/(b+e)$ & $c/(c+f)$ \\
Different source & $d/(a+d)$ & $e/(b+e)$ & $f/(c+f)$ \\\hline
\multicolumn{1}{|r|}{Total \# Decisions} & $a + d$ & $b + e$ & \multicolumn{1}{r|}{$c + f$} \\\hline
\end{tabular}
\end{table}
...
\clearpage
\paragraph{Bunch}  \citep{bunch2003comprehensive}\hfill\newline
Bunch used a study design that is not conducive to a quick summary. The study consisted of 8 test kits of varying composition; the test kits were evaluated by 8 examiners at the FBI laboratory. 
...
\multicolumn{1}{r}{} & Identification & Inconclusive & \multicolumn{1}{r}{Elimination} & Source Probability\\\hline
Same source & 1 & 0 & 0 & \svp{0.1944}\\
Diff source & 0 & 1 & 1 & \svp{0.8056}\\\hline
...
\multicolumn{1}{r}{} & Identification & Inconclusive & \multicolumn{1}{r}{Elimination} & Source Probability\\\hline
Same source & 1.0000 & 0.0000 & 0.0000 & \svp{0.1944}\\
Diff source & 0.0000 & 0.5931 & 0.4069 & \svp{0.8056}\\\hline
\multicolumn{1}{Y}{Conclusion Probability} & 0.1944 & 0.4778 & \multicolumn{1}{r}{0.3278} & \multicolumn{1}{Y}{}\\\hline\hline
\end{tabularx}
...
\multicolumn{5}{c}{\bf Conclusion-Specific Probabilities}\\
\multicolumn{1}{r}{} & Identification & Inconclusive & \multicolumn{1}{r}{Elimination} & Source Probability\\\hline
Same source & 0.9432 & 0.6781 & 0.0769 & 0.6026 \\
Different source & 0.0568 & 0.3219 & 0.9231 & 0.3974 \\\hline
\multicolumn{1}{Y}{Conclusion Probability} & 0.2821 & 0.4679 & \multicolumn{1}{r}{0.2500} & \multicolumn{1}{Y}{}\\\hline\hline

\multicolumn{5}{c}{}\\
\multicolumn{5}{c}{\bf Source-Specific Probabilities}\\
\multicolumn{1}{r}{} & Identification & Inconclusive & \multicolumn{1}{r}{Elimination} & Source Probability\\\hline
Same source & 0.4415 & 0.5266 & 0.0319 & 0.6026\\
Different source & 0.0403 & 0.3790 & 0.5806 & 0.3974\\\hline
\multicolumn{1}{Y}{Conclusion Probability} & 0.2821 & 0.4679 & \multicolumn{1}{r}{0.2500} & \multicolumn{1}{Y}{}\\\hline\hline
\end{tabularx}
...
\multicolumn{5}{c}{\bf Overall Error Rates}\\
Opt. & \multicolumn{1}{c}{Meaning} & Missed Identification & \multicolumn{1}{r}{Missed Elimination} & Total \\\hline
2 & FTE error & 0.0319  & 0.0403 & 0.0663\\
3 & Process error & 0.5585 & 0.4194 & 0.5032\\ \hline
\end{tabularx}
\end{fmpage}
...
\multicolumn{5}{c}{\bf Conclusion-Specific Probabilities}\\
\multicolumn{1}{r}{} & Identification & Inconclusive & \multicolumn{1}{r}{Elimination} & Source Probability\\\hline
Same source & 0.8673 & 0.2857 & 0.0556 & 0.4019 \\
Different source & 0.1327 & 0.7143 & 0.8444 & 0.5981 \\\hline
\multicolumn{1}{Y}{Conclusion Probability} & 0.3576 & 0.2437 & \multicolumn{1}{r}{0.3987} & \multicolumn{1}{Y}{}\\\hline\hline

\multicolumn{5}{c}{}\\
\multicolumn{5}{c}{\bf Source-Specific Probabilities}\\
\multicolumn{1}{r}{} & Identification & Inconclusive & \multicolumn{1}{r}{Elimination} & Source Probability\\\hline
Same source & 0.5213 & 0.1170 & 0.0372 & 0.4019\\
Different source & 0.1210 & 0.4435 & 0.9597 & 0.5981\\\hline
\multicolumn{1}{Y}{Conclusion Probability} & 0.3576 & 0.2437 & \multicolumn{1}{r}{0.3987} & \multicolumn{1}{Y}{}\\\hline\hline
\end{tabularx}
...
\multicolumn{5}{c}{\bf Overall Error Rates}\\
Opt. & \multicolumn{1}{c}{Meaning} & Missed Identification & \multicolumn{1}{r}{Missed Elimination} & Total \\\hline
2 & FTE error & 0.0372  & 0.1210 & 0.0921\\
3 & Process error & 0.1543 & 0.5645 & 0.3133\\ \hline
\end{tabularx}
\end{fmpage}
