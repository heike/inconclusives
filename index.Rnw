...
\svp{We surveyed a number of studies which are commonly cited in Daubert evidence hearings as well as in the literature to validate the process of firearm and toolmark analysis.}
