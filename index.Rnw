...
218 participants provided evaluations of the kits, evaluation results are shown in \autoref{tab:baldwin-totals}.
...
$X = $Reality & Identification & Inconclusive  & Elimination & Totals \\
&&or no response&&\hline
Same source & 4 & 11 & 1075 & 1090\\
Different source & 1480 & 735+2 & 22 & 2180\\\hline
\end{tabu}
}
\end{table}
...
\begin{table}[hbt]
\centering
\caption{Conditional probabilities from Baldwin Study.}\label{tab:baldwin}
{\tabulinesep=1.2mm
\begin{tabu}{|c|ccc|}\hline
$P(X | Y)$ & \multicolumn{3}{c|}{$Y = $Examiner Conclusion} \\\hline
$X = $Reality & Identification & Inconclusive & Elimination \\\hline
