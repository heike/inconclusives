...
Shortly after the report was issued, additional studies were published which also meet the criteria for reliable studies in the report:  \citet{keisler}, \citet{Duez:2017kha}, \svp{\citet{vcmer}, and \citet{mattijssenValidityReliabilityForensic2020}}. 
