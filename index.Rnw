...
<<inconclusives, echo=FALSE, fig.width=8, fig.height=4.5,
fig.cap='Percentage of inconlusive decisions by same-source/different source comparisons. The percentage of inconclusives for same source comparisons is generally low (with a 95 percent confidence interval well below 5 percent). Different source comparisons end up in inconclusive results significantly more often. The Baldwin study has a particularly high percentage of inconclusive results', out.width=".8\\textwidth">>=
