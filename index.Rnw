...
We provide an example of \svp{the effect of extraneous information on estimated error rates} in \Cref{sec:studies}.
Studies which attempt to gain insight into the identification process must navigate these complexities, ideally without becoming too complicated themselves.
