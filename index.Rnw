...
\hh{XXX should we keep the criticism to the discussion?}
...
\hh{XXX From a statistical point of view the approach would imply independence between inconclusive decisions and source of evidence. Based on the case studies this assumption is violated.}

\hh{XXX the approach to start with inconclusives also suggests symmetry - should we put a tease in here for later?}
