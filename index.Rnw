...
\item[Lilien] \citep{vcmer} is an open-set study of breech face comparisons using virtual microscopy. Each of 76 participants received 16 test sets consisting of one standard (2 scans) and 1 questioned scans. In 17 sets, the questioned bullet matched the standards, and in 23 sets, the questioned bullet was fired from a different weapon.
