...
\clearpage
\paragraph{Lilien} The Lilien study  \citep{lilienFirearmForensicsBlackBox2019} used virtual microscopy to evaluate scans of cartridge cases. Each participant was asked to make eight evaluations of breech face impressions. These consisted of forty sets of two known: 
\noindent\begin{fmpage}{.985\textwidth}\centering % Checked numbers 2020-04-24
