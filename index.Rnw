...
\svp{
While we did not attempt to include every study ever performed, we did include studies which are frequently cited in research or legal proceedings, as well as several of the studies mentioned in the PCAST and NAS reports concerning firearm and toolmark analysis. A brief description of each study is provided here for reference purposes, with summary tables of results and conditional probabilities provided in \ref{sec:supplement}.}
