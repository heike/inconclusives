...
errors2 %>%
  ...
  mutate(
    ...
    ErrorType = factor(c("Missed Identification", "Missed Elimination", "Missed Elimination\n(incl. Inconclusives)")[as.numeric(Decision)]),
    ErrorType = factor(ErrorType, levels = c("Missed Identification", "Missed Elimination", "Missed Elimination\n(incl. Inconclusives)"))
  ) %>%
