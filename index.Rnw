...
\subsection{Overview and description of studies}

\hh{Which studies are included and why?}
...
\autoref{fig:errors} shows the overall error rates for all studies

<<errors, echo=FALSE, fig.width=8, fig.height=3,fig.cap="Percentages of missed eliminations and missed identifications by study. 95\\% Pearson-Clopper confidence intervals are drawn around the error estimates.", out.width=".8\\textwidth">>=
errors <- studies %>% 
  mutate(
...
\multicolumn{1}{Y}{Conclusion Total} & 1097 & 748 & \multicolumn{1}{r}{1432} & \multicolumn{1}{Y}{3270}\\\hline\hline
