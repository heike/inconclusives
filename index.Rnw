...
The study was originally reported on by Brundage in 1998 \cite{brundage}
...
Technically, in a closed set such as the Brundage-Hamby study and studies with the same set-up (such as Fadul), we have 
